...
class AdDetailsScreen extends StatefulWidget
{
	...
	@override
	_AdDetailsScreenState createState() => new  _AdDetailsScreenState();
}
class _AdDetailsScreenState extends State<AdDetailsScreen>
{
	final AdBloc _bloc = new AdBloc();
	@override
	void initState()
	{	
						        ...
						        SizedBox(
						          ...
						          child: RaisedButton(
								    ...
								    Navigator.of(context).pushNamed(
										    ...
										    arguments:{
											    RestaurantDetailsScreen.RESTAURANT_ID:snapshot.data.restaurantId
										    })),
						        )
						        ]
						      ),
