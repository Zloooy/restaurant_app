...
class RestaurantSearchBloc {
  ...
  late BehaviorSubject<List<Restaurant>?> _restaurantListHandler;
  ...
  late BehaviorSubject<List<String>> _restaurantTagListHandler;
  ...
  late BehaviorSubject<Restaurant> _oneRestaurantHandler;
  ...
  late BehaviorSubject<List<Holiday>?> _holidayListHandler;
  Stream<List<Holiday>?>? _holidayListHandlerStream;
  late BehaviorSubject<List<Ad>?> _adListHandler;
  ...
  RestaurantSearchBloc() {
    ...
    _oneRestaurantStream = _oneRestaurantHandler.mergeWith(
        [_restaurantIdHandler.map(_db.getRestaurantById).whereNotNull()]);
    _holidayListHandler =
